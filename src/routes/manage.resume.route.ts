...
export const manageResumeRoutes = (app: Elysia) =>
    app.group("/resume", (app) =>
        app
            ...
            .delete("/delete_soft_skill/:soft_skill_id", ResumeController.deleteSoftSkill)

            .post("/increase_education", ResumeController.increaseEducationHistory)
            .put("/education_history/:education_history_id", ResumeController.saveEducationHistory, {
                body: addEducationHistorySchema,
            })
            .delete("/delete_education/:education_history_id", ResumeController.deleteEducationHistory)
            ...
            .put("/work_experience/:work_experience_id", ResumeController.saveWorkExperience, {
                body: addWork_historySchema,
            })
            .delete("/work_experience/:work_experience_id", ResumeController.deleteWorkExperience)
            ...
            .post("/increase_training", ResumeController.increaseTraining)
            .put("/training/:training_id", ResumeController.saveTraining)
            ...
            .put("/additional_info/:additional_info_id", ResumeController.saveAdditionalInfo, {})
            .delete("/additional_info/:additional_info_id", ResumeController.deleteAdditionalInfo)
