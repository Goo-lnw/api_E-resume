...
export const manageResumeRoutes = (app: Elysia) =>
    app.group("/resume", (app) =>
        app
            ...
            .put("/work-experience/:work_experience_id", ResumeController.addWorkExperience, {
            ...
            .put("/education-history/:education_history_id", ResumeController.addEducationHistory, {
