...
export const teacherRoutes = (app: Elysia) =>
    app.group("/teacher", (app) =>
        app
            ...
            .get("/activity/student_cert/:activity_id", teacherController.getStudentActivityCertExist)
            ...
            .delete("/activity/student_cert/:activity_id", teacherController.deleteStudentActivityCert, {
                body: deleteActivityOfStudentSchema,
            })
    );
