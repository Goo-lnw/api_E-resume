...
export const teacherRoutes = (app: Elysia) =>
  app.group("/teacher", (app) =>
    app
      ...
      .get(
        "/activity/student_not_in/:activity_id",
        teacherController.getStudentByNoActivityId
      )
      .get(
        "/activity/student_in/:activity_id",
        teacherController.getStudentByActivityId
      )
      .get(
        "/activity/student_no_cert/:activity_id",
        teacherController.getStudentActivityCertNotExist
      )
      .get(
        "/activity/student_cert/:activity_id",
        teacherController.getStudentActivityCertExist
      )
      ...
      .delete(
        "/activity/student/:activity_id",
        teacherController.deleteActivityStudentCheckin,
        {
      ...
      .delete(
        "/activity/student_cert/:activity_id",
        teacherController.deleteStudentActivityCert,
        {
          body: deleteActivityOfStudentSchema,
        }
      )
